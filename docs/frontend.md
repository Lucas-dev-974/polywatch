...
| **Weather Algo** | `WeatherAlgoPage` : onglets Marchés / Positions / Villes / **Données** / **Backtest** / Paramètres — voir arbre §3 et [`weather-algo.md`](./weather-algo.md) |
...
│   ├── WeatherAlgoPage.tsx             shell weather (6 onglets)
...
│   │   ├── WeatherAlgoBacktestTab.tsx  Backtest : couverture, formulaire, liste, détail
│   │   │   └── BacktestEquityChart.tsx courbe d'equity (SVG)
