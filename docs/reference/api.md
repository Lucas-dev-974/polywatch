...
| POST | `/api/internal/clob-approvals/ensure` | Vérifie/soumet les allowances CLOB **requises pour cet ordre** (`negRisk` + `side` dans le body ; batch relayer, wallet `is_primary`) |
