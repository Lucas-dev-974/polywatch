...
Les constats **D1 à D11** de l'inventaire dead code (§2) ont été implémentés et vérifiés (voir [`../plans/2026-08-13_PLAN-purge-dead-code-weather-algo.md`](../plans/2026-08-13_PLAN-purge-dead-code-weather-algo.md)).
...
Les constats **R1, R2, R3, R5, R6, R7, R8, R9, R10** de la partie 4 (§4) ont été implémentés et vérifiés (voir [`../plans/2026-08-13_PLAN-refactor-weather-algo-r1-r10.md`](../plans/2026-08-13_PLAN-refactor-weather-algo-r1-r10.md)). **R4** était déjà implémenté (résolu par C2, §9).
