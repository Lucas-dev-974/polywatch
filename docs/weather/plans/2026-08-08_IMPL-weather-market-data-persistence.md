...
**Hors scope initial** : Phase 5 (`WeatherDataLoader` / `packages/backtest`) — **implémentée depuis 2026-08-09** ; voir [`../../reference/backtest.md`](../../reference/backtest.md), [`../../plans/2026-08-05_PLAN-backtest-engine-universel.md`](../../plans/2026-08-05_PLAN-backtest-engine-universel.md), et patch [`2026-08-09_PLAN-PATCH-weather-algo-backtest-audit.md`](./2026-08-09_PLAN-PATCH-weather-algo-backtest-audit.md) (`engineVersion` 0.2.0)
...
| Phase 5 backtest | **Implémentée** (2026-08-09) — [`../../reference/backtest.md`](../../reference/backtest.md) |

---

## 7. Doc liée

- Produit : [`../../reference/weather-algo.md`](../../reference/weather-algo.md) § Persistance
- Code package : [`../../code/08-weather-algo.md`](../../code/08-weather-algo.md)
- API : [`../../reference/api.md`](../../reference/api.md) § Weather Algo data
- Modèle : [`../../reference/modele-donnees.md`](../../reference/modele-donnees.md)
