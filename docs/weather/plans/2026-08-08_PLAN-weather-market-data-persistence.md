...
**Référence audit** : `[../audits/2026-08-08_audit-weather-forecast-strategy.md](../audits/2026-08-08_audit-weather-forecast-strategy.md)`
**Référence spec multi-stratégies** : `[../specs/2026-08-08_SPEC_multi-strategy-weather-algo.md](../specs/2026-08-08_SPEC_multi-strategy-weather-algo.md)`
...
Ces données alimentent le backtest weather (Phase 5 — **implémentée**, voir `[../../reference/backtest.md](../../reference/backtest.md)`). **UI livrée** : toggles / rétention dans **Paramètres** + onglet **Données** (exploration / purge) + onglet **Backtest** dans Weather Algo (lancement de runs, métriques, equity).
