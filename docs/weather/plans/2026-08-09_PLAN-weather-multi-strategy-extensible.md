...
- `docs/weather/specs/2026-08-08_SPEC_multi-strategy-weather-algo.md` : marquer comme partiellement implémenté (étape 1 = forecast best-edge/aligned ; spread/convergence/arbitrage = future).
