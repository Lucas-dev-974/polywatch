...
@Entity('real_state_snapshots')
@Index('idx_real_snapshots_source_created', ['source', 'createdAt'])
@Index('idx_real_snapshots_created', ['createdAt'])
export class RealStateSnapshot {
