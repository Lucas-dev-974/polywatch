          ...
          (
            SELECT jsonb_object_agg(
              ...
              jsonb_build_object(
                ...
                'entryUsdc', weather_algo_entry_usdc,
                'sizingMode', weather_algo_sizing_mode,
                ...
                'maxExposureUsdc', weather_algo_max_exposure_usdc,
                'maxDailyLossUsdc', weather_algo_max_daily_loss_usdc,
                'maxPositionSizeUsdc', weather_algo_max_position_size_usdc,
