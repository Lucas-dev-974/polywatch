...
import type { WeatherAlgoDataTableId, CryptoAlgoDataTableId } from './lib/ui-persistence';
...
function shouldUseGetCache(path: string): boolean {
  ...
  return (
    ...
    !path.startsWith('/crypto-algo-data') &&
...
// ─── Crypto algo data (onglet Données) ─────────────────────────────────────
...
export async function fetchCryptoAlgoPriceTicks(params: {
  ...
  return api(`/crypto-algo-data/price-ticks${cryptoAlgoDataQuery(params)}`);
}
...
export async function fetchCryptoAlgoSurveillanceSnapshots(params: {
  ...
  return api(`/crypto-algo-data/surveillance-snapshots${cryptoAlgoDataQuery(params)}`);
}
...
export async function fetchCryptoAlgoPostEntryMidSamples(params: {
  ...
  return api(`/crypto-algo-data/post-entry-mid-samples${cryptoAlgoDataQuery(params)}`);
}
...
export async function fetchCryptoAlgoMarketSelections(params: {
  ...
  return api(`/crypto-algo-data/market-selections${cryptoAlgoDataQuery(params)}`);
}
...
export async function fetchCryptoAlgoAutoTrackRules(params: {
  ...
  return api(`/crypto-algo-data/auto-track-rules${cryptoAlgoDataQuery(params)}`);
}
...
export async function fetchCryptoAlgoExecutions(params: {
  ...
  return api(`/crypto-algo-data/executions${cryptoAlgoDataQuery(params)}`);
}
...
export async function fetchCryptoAlgoPositions(params: {
  ...
  return api(`/crypto-algo-data/positions${cryptoAlgoDataQuery(params)}`);
}
