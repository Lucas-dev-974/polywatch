// ─── Coeur HTTP de l'API : fetch, cache GET, auth/tokens, session ─────────
// Partagé par tous les modules API (config, backtest, weather, crypto).
...
/** Sérialise les paramètres de requête en querystring (ignore undefined/''). */
